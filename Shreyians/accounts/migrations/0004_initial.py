# Generated by Django 5.2.8 on 2026-01-05 02:51
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0003_delete_userlogin'),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_validity', models.CharField(blank=True, max_length=255)),
                ('is_live', models.BooleanField(default=False)),
                ('image', models.ImageField(upload_to='course_images/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('tags', models.ManyToManyField(blank=True, related_name='courses', to='accounts.coursetag')),
            ],
            options={
                'ordering': ['title'],
            },
